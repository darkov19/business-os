---
description: Structure a SaaS or digital product business using the Business OS SaaS workflow.
argument-hint: "[saas, ai tool, or digital product context]"
disable-model-invocation: true
---

Use the Business OS `SaaS / Digital Product` workflow for:
