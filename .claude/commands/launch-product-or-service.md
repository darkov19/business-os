---
description: Prepare a product or service for launch using the Business OS launch workflow.
argument-hint: "[offer or launch context]"
disable-model-invocation: true
---

Use the Business OS `Launch A New Product Or Service` workflow for:
...
3. Keep the workflow execution-aware.
4. Do not recommend launch if pricing, delivery, or channels are still speculative.
